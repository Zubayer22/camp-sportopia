...
const Navbar = () => {
    ...
    const { user, logOut,toogle, setToogle} = useContext(AuthContext);
            ...
            <div className="navbar text-white container mx-auto py-2 px-3 md:py-5 md:px-0">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52 text-black font-bold z-50">
                            {navOptions}
                        </ul>
                    </div>
                    <Link to="/" className="btn btn-ghost normal-case text-xl">CampSportipia</Link>
                </div>
                ...
                <div className="navbar-end">
                    <button onClick={() => setToogle(!toogle)} className="text-xl mr-2"><FaSun></FaSun></button>
                    {
                        user ?
